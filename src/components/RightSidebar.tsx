...
const RightSidebar = () => {
  ...
  return (
    <div className="fixed right-4 top-20 bottom-4 w-80 bg-vanta-blue-medium text-vanta-text-light flex flex-col z-40 rounded-[27px] font-outfit p-6"> {/* Changed rounded-l-[27px] to rounded-[27px] */}
      {/* Logo and Match Code */}
